...
## TL;DR
 ...
 ✔️ |    **I'm seeking for a new job opportunity**

Alex is an independent contractor, former “full stack” game developer now focusing mainly on writing modern C++ code. Hard worker, always learning something new. Reliable and friendly person. 
Lead of Unreal User Group Slovakia.

## Experience

### Software engineer ( C++ ) @ Chaos Group

>  **Period:** Jun 2019 - Jun 2020, Contact (b2b)
...
- Responsibilities on the project:
	...
	- Contribute on overall planning
...
Unleash the power of the project management tools like Trello, Assembla, Jira in Unreal Engine! Create tickets from plugin editor window, from comments in your blueprints or from visual todos created right in the level. Make new comments, complete tasks, assign members, labels and due dates right in the Unreal editor.
...
-   Responsibilities in the company:
    ...
    -   Do new prototypes for AR / Hololens / VR various types of industry ( automotive, art, culture, banking .. )
